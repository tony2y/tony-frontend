<template>
  ...
  <div class="app-container">
    <el-row>
      ...
      <el-col :span="20">
        <el-col :span="1"><div style="background: #99a9bf;" /></el-col>
        ...
        >
          ...
          <el-table-column label="编号" prop="userId" align="center" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="30%">
      <el-form ref="dataForm" :rules="rules" :model="user" label-position="left" label-width="70px" style="width: 300px; margin-left:50px;">
        ...
        <el-form-item label="原密码" prop="oldPwd">
          <el-input v-model="user.oldPwd" type="password" placeholder="请输入原密码" show-password />
        </el-form-item>
